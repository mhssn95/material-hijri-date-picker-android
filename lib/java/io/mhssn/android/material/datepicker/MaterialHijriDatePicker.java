...
package io.mhssn.android.material.datepicker;
...
public final class MaterialHijriDatePicker<S> extends DialogFragment {
  ...
  @NonNull
  static <S> MaterialHijriDatePicker<S> newInstance(@NonNull Builder<S> options) {
    MaterialHijriDatePicker<S> materialHijriDatePickerDialogFragment = new MaterialHijriDatePicker<>();
    ...
    materialHijriDatePickerDialogFragment.setArguments(args);
    return materialHijriDatePickerDialogFragment;
  }
  ...
  public final Dialog onCreateDialog(@Nullable Bundle bundle) {
    ...
    int surfaceColor =
        MaterialAttributes.resolveOrThrow(
            context, R.attr.colorSurface, MaterialHijriDatePicker.class.getCanonicalName());
    background =
   ...
   * MaterialHijriDatePicker#addOnPositiveButtonClickListener}.
   */
  ...
  /**
   * Removes all listeners added via {@link MaterialHijriDatePicker#addOnPositiveButtonClickListener}.
   */
  ...
  /**
   * Removes a listener previously added via {@link
   * MaterialHijriDatePicker#addOnNegativeButtonClickListener}.
   */
  ...
  /**
   * Removes all listeners added via {@link MaterialHijriDatePicker#addOnNegativeButtonClickListener}.
   */
  ...
  /** Removes a listener previously added via {@link MaterialHijriDatePicker#addOnCancelListener}. */
  public boolean removeOnCancelListener(DialogInterface.OnCancelListener onCancelListener) {
    return onCancelListeners.remove(onCancelListener);
  }

  /** Removes all listeners added via {@link MaterialHijriDatePicker#addOnCancelListener}. */
  ...
  /** Removes a listener previously added via {@link MaterialHijriDatePicker#addOnDismissListener}. */
  public boolean removeOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
    return onDismissListeners.remove(onDismissListener);
  }

  /** Removes all listeners added via {@link MaterialHijriDatePicker#addOnDismissListener}. */
  ...
  public static final class Builder<S> {
    ...
    /** Creates a {@link MaterialHijriDatePicker} with the provided options. */
    @NonNull
    public MaterialHijriDatePicker<S> build() {
      ...
      return MaterialHijriDatePicker.newInstance(this);
    }
